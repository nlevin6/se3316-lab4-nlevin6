    ...
    return (
        <div className="text-center">
            ...
            <form className="flex flex-col items-center justify-center">
                ...
                <input type="text" id="username" name="username" className="border rounded py-2 px-3 mb-4" />

                <label htmlFor="password" className="mb-2">Password:</label>
                <input type="password" id="password" name="password" className="border rounded py-2 px-3 mb-4" />
